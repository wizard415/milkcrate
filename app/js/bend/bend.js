...
(function() {
    ...
    var bendFn = function() {
        ...
        var restoreActiveUser = function(options) {
            ...
            var promise = AsyncStorage.getItem('activeUser');

            return promise.then(function(userStr) {
        ...
        Bend.setActiveUser = function(user) {
            ...
            if(null != user) { // Save the active user.
                AsyncStorage.setItem('activeUser', JSON.stringify([user._id, user._bmd.authtoken]));
            }
        ...
        Bend.Error = {
            ...
            BEND_INTERNAL_ERROR_RETRY:'BendInternalErrorRetry',
            BEND_INTERNAL_ERROR_STOP:'BendInternalErrorStop',
            ...
            OAUTH_TOKEN_REFRESH_ERROR:'OAuthTokenRefreshError',
            BL_VIOLATION_ERROR:'BLViolationError',
            BL_INTERNAL_ERROR:'BLInternalError',
            THIRD_PARTY_TOS_UNACKED:'ThirdPartyTOSUnacked',
            STALE_REQUEST:'StaleRequest',
            DATA_LINK_PARSE_ERROR:'DataLinkParseError',
            NOT_IMPLEMENTED_ERROR:'NotImplementedError',
            EMAIL_VERIFICATION_REQUIRED:'EmailVerificationRequired',
            SORT_LIMIT_EXCEEDED:'SortLimitExceeded',
            INVALID_SHORT_URL:'InvalidShortURL',
            INVALID_OR_MISSING_NONCE:'InvalidOrMissingNonce',
            MISSING_CONFIGURATION:'MissingConfiguration',
            ENDPOINT_DOES_NOT_EXIST:'EndpointDoesNotExist',
            DISALLOWED_QUERY_SYNTAX:'DisallowedQuerySyntax',
            MALFORMED_AUTHENTICATION_HEADER:'MalformedAuthenticationHeader',
            APP_ARCHIVED:'AppArchived',
            BL_NOT_SUPPORTED_FOR_ROUTE:'BLNotSupportedForRoute',
            USER_LOCKED_DOWN:'UserLockedDown',
            ALREADY_LOGGED_IN:'AlreadyLoggedIn',
            DATABASE_ERROR:'DatabaseError',
            MISSING_APP_CREDENTIALS:'MissingAppCredentials',
            MISSING_MASTER_CREDENTIALS:'MissingMasterCredentials',
        ...
        Bend.File = /** @lends Bend.File */ {
            ...
            upload: function(file, data, options) {
                ...
                promise = promise.then(function(response) {
                    ...
                    var upload = RNFetchBlob.fetch('PUT', url, {
